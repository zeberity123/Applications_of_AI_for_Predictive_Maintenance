...
#         <<<TODO>>> # create your model here
        model.add(LSTM(128, dropout = dp_lvl,recurrent_dropout = dp_lvl, return_sequences = True,
        ...
        model.add(Dense(data_shape[-1], activation='tanh',activity_regularizer=regularizers.l2(regularizer_lvl)))
